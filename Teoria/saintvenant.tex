...
\section{Analisi della flessione}
	...
	\subsection{Analisi della flessione deviata}
		...
		\end{osservazione}
		L'asse deformato giace dunque nel piano perpendicolare all'asse neutro ed è possibile valutare lo spostamento $\delta$ di un punto dall'asse neutro e l'inclinazione $d\delta/dz$ dell'asse come
