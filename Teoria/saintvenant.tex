...
\section{Analisi della torsione}
    ...
    \subsection{Rappresentazione dello stato di tensione}
    	...
    	Usando le regole di trasformazione per rotazione dei tensori è possibile calcolare le componenti lungo gli assi $z',\theta'$ di un sistema di riferimento ottenuto per rotazione di un angolo $\phi$ rispetto al sistema principale:
    	\[ L = \begin{bmatrix}
